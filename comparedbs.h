...
static QVector<QTableWidget*>* compareDbs(QSqlRelationalTableModel* &model1, QSqlRelationalTableModel* &model2, QStringList list = QStringList()){
                    ...
                    if (test == 0){
                        ...
                        for(int col = 0; col < columnCount; col++){
                            ...
                            if (record1.field(fieldName).value().toString() != record2.field(fieldName).value().toString()){
                                ...
                                qDebug() << record1.field(fieldName).value().toString() << record2.field(fieldName).value().toString();
                            }
                            table1->setItem(rows-1,col, newItem1);
                            table2->setItem(rows-1,col, newItem2);
                        }
    ...
    QString query = "SELECT Stations.NameSt, TS_Name.NameTs";
    ...
    query.append(" FROM TS, TS_Name, Stations WHERE Stations.NameSt='"+stationName+"' AND TS.Cod=TS_Name.Cod AND TS.NoSt=Stations.NoSt ORDER BY TS.Module,TS.I, TS.J, TS_Name.NameTs ASC;");
    ...
    QStringList  listOfColumns = {"NameSt","NameTs"};
